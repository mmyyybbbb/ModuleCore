...
public final class TableReactor<Item>: BaseReactor, SceneReactor {
...
fileprivate extension TableReactor {
    func reloadData() {
        interact(dataLoaderProvider(),
                 complete: TableReactor<Item>.dataReloaded,
                 error: TableReactor<Item>.loadingFailed,
    ...
    func loadMore() {
        ...
        interact(moreLoader(offset),
                 complete: TableReactor<Item>.loadedMore,
                 error: TableReactor<Item>.loadingFailed,
